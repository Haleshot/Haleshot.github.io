...
I proposed the talk because I contribute to [CocoIndex](https://github.com/cocoindex-io/cocoindex) and the project recently shipped a [Kafka connector](https://cocoindex.io/docs/connectors/kafka/). (The last time I spoke about CocoIndex was at [Rust Delhi](https://www.linkedin.com/posts/srihari-thyagarajan_kicking-off-2026-with-rust-delhi-meetup-12-ugcPost-7420450967495667712-H-yH/) earlier this year.) That made the meetup a good place to explain the connector through the problem it solves rather than through implementation details. My one-line version of the talk was to declare what each key should contain, let CocoIndex reconcile the difference, and let Kafka fan it out.
