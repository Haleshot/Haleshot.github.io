---
title: Image Processing Techniques with PyQt5 GUI
summary: A project on Image Processing, leveraging PyQt5 for a user-friendly GUI and implementing essential operations like Low Pass Filter, Downsampling, Upsampling, Thresholding, and Negative Image Generation. It offers a visually engaging experience while exploring the realm of image processing techniques.
tags:
 - Image Processing
 - PyQt5
 - OpenCV
...
links:
 - icon: github
   icon_pack: fab
   name: GitHub
   url: 'https://github.com/Haleshot/Image_Processing'  # add your GitHub repository URL here
...
This project provided hands-on experience in image processing techniques, GUI development, and integrating various Python libraries. It serves as a foundation for further exploration in the field of image processing and computer vision.
